...
class Dav extends Human {
    constructor(
        id,name, username, email, address = {}, phone, website, company = {}, skils = [])
        {
        super(
        id,name, username, email, address, phone, website, company)
            this.skils = skils
        }
      coding(){console.log('tap tap tap')};
    }
...
let b = new Dav(1, 'Vasia', 'Pupkin', 'vasia@gmail.com',
 { 
street: 'Kulas Light',
suite: 'Apt. 556',
city: 'Gwenborough',
